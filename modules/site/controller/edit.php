...
class Site_Controller_Edit extends Admin_Form_Action_Controller_Type_Edit
{
	...
	public function setObject($object)
	{
		...
		$oSiteTabAccessRights = Core::factory('Admin_Form_Entity_Tab')
			->caption(Core::_('Site.site_chmod'))
			->name('AccessRights');

		$oSiteTabFormats = Core::factory('Admin_Form_Entity_Tab')
			->caption(Core::_('Site.site_dates'))
			->name('Formats');

		$oSiteTabErrors = Core::factory('Admin_Form_Entity_Tab')
			->caption(Core::_('Site.site_errors'))
			->name('Errors');

		$oSiteTabRobots = Core::factory('Admin_Form_Entity_Tab')
			->caption(Core::_('Site.site_robots_txt'))
			->name('Robots');

		$oSiteTabLicense = Core::factory('Admin_Form_Entity_Tab')
			->caption(Core::_('Site.site_licence'))
			->name('License');

		$oSiteTabCache = Core::factory('Admin_Form_Entity_Tab')
			...
			&& Core::isFunctionEnable('exec'))
		{
			...
			if (isset($sys_result) && count($sys_result) > 0)
			{
				...
				$oLocaleField = new Admin_Form_Entity_Select();
				$oLocaleField
					->name('locale')
		...
		$oTimezoneField = new Admin_Form_Entity_Select();
		$oTimezoneField
			->name('timezone')
		...
		$oIcoFileField = new Admin_Form_Entity_File();
		...
		$oSelect_404 = new Admin_Form_Entity_Select();
		$oSelect_404
			->options(
				$aStructureData
			)
		...
		$oSelect_403 = new Admin_Form_Entity_Select();
		$oSelect_403
			->options(
				$aStructureData
			)
		...
		$oSelect_503 = new Admin_Form_Entity_Select();
		$oSelect_503
			->options(
				$aStructureData
			)
