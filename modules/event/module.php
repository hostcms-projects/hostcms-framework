...
class Event_Module extends Core_Module{	/**
	...
	public function getCalendarContextMenuActions()
	{
		...
		return array('<a href="javascript:void(0);" onclick="$.modalLoad({path: \'/admin/event/index.php\', action: \'edit\', operation: \'modal\', additionalParams: \'hostcms[checked][0][0]=1\', windowId: \'id_content\'}); return false">' . Core::_('Event.add_event') . '</a>');
	}
