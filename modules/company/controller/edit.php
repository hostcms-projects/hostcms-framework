...
class Company_Controller_Edit extends Admin_Form_Action_Controller_Type_Edit{
	...
	protected function _applyObjectProperty()
	{
		...
		$aAddresses = Core_Array::getPost('address');
		$aAddress_Country = Core_Array::getPost('address_country');
		$aAddress_Postcode = Core_Array::getPost('address_postcode');
		$aAddress_City = Core_Array::getPost('address_city');
		$aAddress_Types = Core_Array::getPost('address_type');
